...
<head>
    <title>Code coverage report for src/libraries/handlers/postTypeArchive.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/libraries/handlers</a> postTypeArchive.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">11x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Handler } from "../../../types";
...
const postTypeArchiveHandler = ({
  ...
  const link = linkArg || <span class="branch-1 cbranch-no" title="branch not covered" >routeArg;</span>
  const { api, populate, parse, getTotal, getTotalPages } = libraries.source;
  const { page, query, route } = parse(link);
&nbsp;
  // 1. fetch the specified page
  const response = await api.get({
    endpoint: endpoint === "posts" ? state.source.postEndpoint : <span class="branch-1 cbranch-no" title="branch not covered" >endpoint,</span>
    params: {
      search: query.s,
      page,
      _embed: true,
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (page &gt; 1 &amp;&amp; items.length === 0)
<span class="cstat-no" title="statement not covered" >    throw new ServerError(`post archive doesn't have page ${page}`, 404);</span>
&nbsp;
...
&nbsp;
    ...
    ...(query.s &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >{ isSearch: true, searchQuery: query.s })</span>,
  };
&nbsp;
