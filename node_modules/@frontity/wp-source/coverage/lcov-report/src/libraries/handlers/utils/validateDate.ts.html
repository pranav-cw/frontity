...
<head>
    <title>Code coverage report for src/libraries/handlers/utils/validateDate.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/libraries/handlers/utils</a> validateDate.ts</h1>
        <div class='clearfix'>
...
<a name='L44'></a><a href='#L44'>44</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">12x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { ServerError } from "@frontity/source";
&nbsp;
/**
 *
