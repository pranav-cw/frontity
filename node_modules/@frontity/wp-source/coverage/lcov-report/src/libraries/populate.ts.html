...
<head>
    <title>Code coverage report for src/libraries/populate.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/libraries</a> populate.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">9x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { State } from "frontity/types";
...
&nbsp;
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (schema === "postType") {
        entityMap = state.source.type;
        entityKey = entity.slug;
      } else <span class="cstat-no" title="statement not covered" >if (schema === "taxonomyType") {</span>
<span class="cstat-no" title="statement not covered" >        entityMap = state.source.taxonomy;</span>
<span class="cstat-no" title="statement not covered" >        entityKey = entity.slug;</span>
      }
&nbsp;
