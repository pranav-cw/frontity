...
<head>
    <title>Code coverage report for src/libraries/schemas/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/libraries/schemas</a> index.ts</h1>
        <div class='clearfix'>
...
<a name='L30'></a><a href='#L30'>30</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">11x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">11x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { schema } from "normalizr";
...
export const entity = new schema.Union(
  ...
  (val) =&gt; {
    ...
    else <span class="missing-if-branch" title="if path not taken" >I</span>if (val.types &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >val.rest_base)</span> <span class="cstat-no" title="statement not covered" >return "taxonomyType";</span>
