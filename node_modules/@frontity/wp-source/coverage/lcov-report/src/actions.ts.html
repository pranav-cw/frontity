...
<head>
    <title>Code coverage report for src/actions.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> actions.ts</h1>
        <div class='clearfix'>
...
<a name='L270'></a><a href='#L270'>270</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">9x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">9x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { URL, error } from "frontity";
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (redirection) <span class="cstat-no" title="statement not covered" >route = redirection.func(redirection.params);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      error("Add the URL of your WordPress REST API in state.source.api.");</span>
    }
&nbsp;
...
&nbsp;
    ...
    const { handlers, redirections } = libraries.source;
&nbsp;
    const patterns = isWpCom ? <span class="branch-0 cbranch-no" title="branch not covered" >wpCom </span>: wpOrg;
...
&nbsp;
    if (homepage) {
      ...
      redirections.push({
        ...
        priority: 10,
        pattern,
        func: <span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >concatPath(homepage),</span>
      });
    }
&nbsp;
    if (postsPage) {
      ...
      redirections.push({
        ...
        priority: 10,
        pattern,
        func: <span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >"/",</span>
      });
    }
&nbsp;
    if (categoryBase) {
...
&nbsp;
    if (subdirectory) {
      ...
      redirections.push({
        ...
        priority: 10,
        pattern,
        func: <span class="fstat-no" title="function not covered" >({</span> subpath = <span class="branch-0 cbranch-no" title="branch not covered" >"" </span>}) =&gt; <span class="cstat-no" title="statement not covered" >`/${subpath}${subpath ? "/" : ""}`,</span>
      });
      // Remove old direction.
      redirections.push({
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Aug 11 2020 22:00:23 GMT+0200 (Central European Summer Time)
            </div>
        </div>
