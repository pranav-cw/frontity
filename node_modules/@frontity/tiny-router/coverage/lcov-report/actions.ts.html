...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import TinyRouter from "../types";
...
export const set: TinyRouter["actions"]["router"]["set"] = ({
  ...
  // Normalizes link.
  <span class="missing-if-branch" title="else path not taken" >E</span>if (libraries.source &amp;&amp; libraries.source.normalize)
...
&nbsp;
  if (
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (state.router.autoFetch) actions.source.fetch(link);
...
export const init: TinyRouter["actions"]["router"]["init"] = ({
  ...
  if (state.frontity.platform === "server") {
    ...
    window.addEventListener("popstate", (event) =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (event.state) {
        actions.router.set(
...
export const beforeSSR: TinyRouter["actions"]["router"]["beforeSSR"] = ({
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (state.router.autoFetch) {
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Jun 02 2020 19:10:21 GMT+0200 (Central European Summer Time)
            </div>
        </div>
